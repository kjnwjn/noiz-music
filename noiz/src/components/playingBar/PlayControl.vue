    ...
    <div class="play-control grid grid-rows-2 grid-flow-col">
        <div class="play-control_list h-full flex justify-center items-center mt-2">
            <div class="play-control_left">
                <button :class="['shuffle_btn', { active: isShuffle }]" @click="handleShuffle">
            ...
            <div class="play-control_right">
                ...
                <button :class="['repeat_btn', { active: isRepeat }]" @click="handleRepeat">
        ...
        <div class="play-control_bar">
            <div class="playback-bar flex items-center flex-row mt-2">
                ...
                <div class="process-bar_container basis-5/6">
                    <div class="process-bar_content">
                        ...
                        />
                        <span id="range-value-bar" ref="rangeValueBar" :style="{ width: `${songPercent}%` }"></span>
                    </div>
                </div>
            ...
            <audio @timeupdate="handlePlayingAudio($event)" src="" id="player" ref="audio"></audio>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {},
    methods: {
        ...mapControllerActions(["handleShuffle", "handleRepeat", "handleOnSeeking", "handleNextSong"]),
